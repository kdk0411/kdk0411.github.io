...
class PositionalEncoding(tf.keras.layers.Layer):
    ...
    def positional_encoding(self, position, d_model):
        ...
        # 배열의 짝수 인덱스(2i)에는 Sin 함수를 적용
        sines = tf.math.sin(angle_rads[:, 0::2])
        
        # 배열의 홀수 인덱스(2i+1)에는 Cos함수를 적용
...
![png](../../../Downloads/Transformer/output_1_1.png)
...
```python
def transformer(vocab_size, num_layers, dff,d_model, 
...
```python
print("Sample rate : ", len(train_data)
```
